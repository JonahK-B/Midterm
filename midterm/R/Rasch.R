...
#' \item \code{{y} An answer vector of length n, where y[i] = 1 if they got the question correct and 0 if they got the question incorrect}
#' 
#' }
#'
#' @author Jonah Klein-Barton: \email{jonahkleinbarton@@gmail.com}
#' @aliase Rasch-class initialize
#' @rdname Rasch
#' @export
